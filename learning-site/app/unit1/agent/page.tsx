    ...
    <main className="app-shell">
      <aside className="sidebar">
        ...
        <nav aria-label="课程章节">
          ...
          <Link className="nav-item active" href="/unit1/agent"><span>01</span>什么是智能体？</Link>
      ...
      <section className="content">
        <header className="topbar">
          ...
          <div className="top-actions"><span className="status-dot" />本地学习模式　<Link href="/">完整课程中心 →</Link></div>
        </header>
